...
<img width="794" height="578" alt="image" src="https://github.com/user-attachments/assets/fb4e2269-0385-48d2-b89f-d3184131fde0" />
...
4.	Arduino Uno: Drag and drop an Arduino Uno R3 board from the components panel onto the workspace.
5.	Ultrasonic Sensor: Search for the HC-SR04 Ultrasonic Distance Sensor and place it on the workspace.
6.	Wires: Use jumper wires to make electrical connections between components.
...
9.	Open Code Editor: Click on the “Code” button at the top right and switch to “Text” mode to write the code in C/C++.
...
<img width="1919" height="978" alt="image" src="https://github.com/user-attachments/assets/7895341a-6bca-4334-ad37-21bee6bd3de1" />
